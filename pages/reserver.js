        ...
        <Reveal className="resa-grid" style={{ display: 'grid', gridTemplateColumns: '3fr 2fr', gap: 60 }}>
          ...
          <div>
            ...
            <div>
              ...
              <a href={RESTAURANT.phoneHref} style={{ display: 'inline-flex', alignItems: 'center', gap: 12, background: '#111', border: '1px solid #1c1c1c', padding: '14px 20px', textDecoration: 'none', color: '#fff', fontFamily: 'Oswald', fontSize: '1.1rem' }}>📞 09 85 00 27 73</a>
            </div>
          </div>
        </Reveal>
      </div>
