...
export default function Reserver() {
  ...
  return (
    <>
      <Seo title="Click & Collect — Pré-commande à emporter | O'77 Pontault-Combault" description="Pré-commande ton repas chez O'77 à Pontault-Combault et retire-le à l'heure choisie (Click & Collect). Fast-food & pizzeria, 7j/7 de 11h à 1h." path="/reserver" />
        ...
        <Reveal className="resa-grid" style={{ display: 'grid', gridTemplateColumns: '3fr 2fr', gap: 60 }}>
          ...
          <div>
            ...
            <div>
              ...
              <a href={RESTAURANT.phoneHref} style={{ display: 'inline-flex', alignItems: 'center', gap: 12, background: '#111', border: '1px solid #1c1c1c', padding: '14px 20px', textDecoration: 'none', color: '#fff', fontFamily: 'Oswald', fontSize: '1.1rem', borderRadius: 12 }}><Phone size={18} /> 09 85 00 27 73</a>
            </div>
          </div>
        </Reveal>
      </div>
