...
const ITEMS = [
  ...
  { src: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=500&h=600&fit=crop', label: 'Naan Cheesy' },
  ...
  { src: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=500&h=380&fit=crop', label: 'Le Spot' },
  ...
  { src: 'https://images.unsplash.com/photo-1586190848861-99aa4a171e90?w=500&h=460&fit=crop', label: 'Signature' },
]

export default function Galerie() {
  return (
    <>
      <Seo title="Galerie — Photos Fast-food & Pizzas | O'77 Pontault-Combault" description="Découvrez en photos les pizzas, sandwichs, naans et burgers faits maison d'O'77, fast-food & pizzeria à Pontault-Combault." path="/galerie" />
