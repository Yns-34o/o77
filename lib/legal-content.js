...
export const LEGAL_PAGES = {
  cgv: [
    ...
    { id: 'cgv-1', title: 'Article 1 — Objet', body: `Les CGV ont pour objet de définir les conditions de vente des produits de restauration proposés par O'77 (pizzas, sandwiches, burgers, tacos, accompagnements, boissons), pour une consommation sur place, à emporter ou en livraison.` },
    { id: 'cgv-2', title: 'Article 2 — Commandes', body: `- **À emporter :** la pré-commande s'effectue via le formulaire du site. Le client choisit la date et l'heure de retrait sur place ({{address}}).\n- **Livraison :** les commandes en livraison s'effectuent via la plateforme partenaire Deliveroo, et sont soumises aux conditions propres à cette plateforme.\n- O'77 se réserve le droit de refuser une commande pour indisponibilité d'un produit ou motif légitime.` },
    ...
    { id: 'cgv-4', title: 'Article 4 — Paiement', body: `Les commandes sur place et à emporter sont réglées directement au restaurant (espèces, carte bancaire). Les commandes en livraison sont payées via la plateforme Deliveroo selon ses moyens de paiement.` },
  ...
  'politique-confidentialite': [
    ...
    { id: 'pc-donnees', title: 'Données collectées', body: `- **Pré-commande à emporter :** prénom, nom, email, téléphone, date et heure de retrait souhaitées, contenu de la commande.\n- **Contact :** nom, email, message.\n- **Données techniques :** aucune donnée de navigation nominative n'est collectée à des fins commerciales.` },
